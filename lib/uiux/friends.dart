        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(20*fem, 70*fem, 20*fem, 100*fem),
              width: double.infinity,
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(15*fem, 13*fem, 254*fem, 13*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(66*fem, 0*fem, 58*fem, 43*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(5*fem, 0*fem, 168*fem, 32*fem),
                    width: double.infinity,
                    height: 42*fem,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(5*fem, 0*fem, 168*fem, 0*fem),
                    width: double.infinity,
                    height: 42*fem,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
            ...
            Container(
              // frame12rPP (49:368)
              padding: EdgeInsets.fromLTRB(42*fem, 25*fem, 43.33*fem, 28*fem),
              width: double.infinity,
              decoration: BoxDecoration (
                color: Color(0xffffffff),
                boxShadow: [
