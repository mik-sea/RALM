        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(41*fem, 26*fem, 33*fem, 26*fem),
              width: double.infinity,
              decoration: BoxDecoration (
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 34*fem, 20*fem),
                    width: 20*fem,
                    height: 20*fem,
                    child: Image.asset(
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(20*fem, 39*fem, 24*fem, 83*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(19*fem, 0*fem, 12*fem, 27*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                  ...
                  Container(
                    // group71Qi9 (62:239)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 87*fem, 16*fem),
                    padding: EdgeInsets.fromLTRB(11*fem, 4*fem, 7*fem, 2*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                  ...
                  Container(
                    // group69yAu (62:226)
                    margin: EdgeInsets.fromLTRB(87*fem, 0*fem, 0*fem, 16*fem),
                    width: 244*fem,
                    height: 51*fem,
                    decoration: BoxDecoration (
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(25*fem, 29*fem, 33*fem, 26.29*fem),
              width: double.infinity,
              decoration: BoxDecoration (
                color: Color(0xfff7f7f7),
                borderRadius: BorderRadius.circular(18*fem),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // typeherepzh (52:575)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 114*fem, 4.71*fem),
                    child: Text(
                      'Type here...',
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 20*fem, 1.71*fem),
                    width: 25*fem,
                    height: 25*fem,
                    child: Image.asset(
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 18*fem, 1.71*fem),
                    width: 25*fem,
                    height: 25*fem,
                    child: Image.asset(
